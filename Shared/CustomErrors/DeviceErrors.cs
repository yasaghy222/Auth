...
public static class UserErrors
{
    ...
    public static Error DuplicateUserName(string username) => Error.Forbidden("User.DuplicateUserName", $"your input Username:'{username}' already is exist'.");

    public static Error NotFound() => Error.NotFound("User.NotFound", $"there are no user with this data exist in the database.");
}
